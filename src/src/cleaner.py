...
def move_rename_file(path):
    from src.handlerOfRings import main_folder_path
    k = 1
...
def sorting():
        ...
        return f'Strange extensions were found in the folder: {found_extensions}.\
                    ...
                    documents: {found_documents} \n \
                        music: {found_audio} \n \
                            archives: {found_archives} \n'+\
                                "Sorting was completed successfully"
